...
{
    public class CreateTipoGastoRequestValidator : AbstractValidator<CreateTipoGastoRequest>
    {
        public CreateTipoGastoRequestValidator()
        {
            RuleFor(x => x.Nombre)
    ...
    public class UpdateTipoGastoRequestValidator : AbstractValidator<UpdateTipoGastoRequest>
    {
        public UpdateTipoGastoRequestValidator()
        {
            RuleFor(x => x.IdTipoGasto)
            .NotEmpty().WithMessage("El IdTipoGasto es obligatorio")
            .GreaterThan(0).WithMessage("El IdTipoGasto debe ser un número mayor a 0");
