...
VALUES 
    ...
    (2, 1, 10, 'Firma 2 - Gerente General', 'EN_REVISION_F2', 'Autorización del Gerente General de la Empresa/Sucursal', NULL, 0, 0, 1, 0, 0),
    
    -- Firma 3: CxP (Polo) - Asigna Centro de Costo y Cuenta Contable
    (3, 1, 20, 'Firma 3 - CxP', 'EN_REVISION_F3', 'Revisión de CxP, asignación de centro de costo y cuenta contable', 'Firma3Handler', 0, 0, 1, 0, 0),
    
    -- Firma 4: GAF (Diego) - Configura checks de comprobación
    (4, 1, 30, 'Firma 4 - GAF', 'EN_REVISION_F4', 'Autorización del Gerente de Administración y Finanzas', 'Firma4Handler', 0, 0, 1, 0, 0),
    
    -- Firma 5: Dirección Corporativa (Hector) - Solo para montos > $100k
    (5, 1, 40, 'Firma 5 - Dirección Corporativa', 'EN_REVISION_F5', 'Autorización de Dirección Corporativa para montos mayores a $100,000', NULL, 0, 0, 1, 0, 0),
    
    -- Estados post-autorización
    (6, 1, 50, 'Autorizada', 'AUTORIZADA', 'Orden autorizada, lista para pago', NULL, 0, 0, 0, 0, 0),
    (7, 1, 60, 'En Tesorería', 'EN_TESORERIA', 'Orden en proceso de pago por Tesorería', NULL, 0, 0, 0, 0, 0),
    (8, 1, 70, 'Pagada', 'PAGADA', 'Pago realizado, pendiente de comprobación', NULL, 0, 0, 0, 0, 0),
    (9, 1, 80, 'En Comprobación', 'EN_COMPROBACION', 'Usuario subiendo comprobantes de gasto', NULL, 0, 0, 0, 0, 1),
...
VALUES 
    ...
    (1, 1, 5, NULL),  -- Rol: Capturista
    
    -- Paso 2 (Firma 2): Gerentes Generales por Sucursal
    (2, 2, 10, NULL), -- Rol: Gerente General
    -- O usuarios específicos:
    -- (3, 2, NULL, 101), -- Martha Anaya (Guadalajara)
    -- (4, 2, NULL, 102), -- Alfredo Corona (CDMX)
    
    -- Paso 3 (Firma 3): CxP - Marco Polo
    (5, 3, NULL, 200), -- Usuario específico: Marco Polo Narvaez
    
    -- Paso 4 (Firma 4): GAF - Diego
    (6, 4, NULL, 201), -- Usuario específico: Diego Villaseñor
    
    -- Paso 5 (Firma 5): Dirección Corporativa - Hector
    (7, 5, NULL, 202), -- Usuario específico: Hector Velez
    
    -- Tesorería
    (8, 7, 15, NULL),  -- Rol: Tesorería
    
    -- Comprobación: Usuario original + CxP
    (9, 9, 5, NULL),   -- Rol: Capturista (usuario que creó la orden)
    (10, 9, NULL, 200); -- Usuario: Marco Polo (valida comprobación)
...
VALUES 
    ...
    (1, 1, 2, 'Enviar a autorización', 'APROBACION', 'primary'),
    ...
    (7, 3, 1, 'Devolver a corrección', 'RETORNO', 'warning'),
