...
@/home/zury/workplace/01-lefarma-project/.opencode/get-shit-done/references/thinking-models-execution.md
...
**See @/home/zury/workplace/01-lefarma-project/.opencode/get-shit-done/references/checkpoints.md**
...
```bash
node /home/zury/workplace/01-lefarma-project/.opencode/get-shit-done/bin/gsd-tools.cjs commit-to-subrepo "{type}({phase}-{plan}): {concise task description}" --files file1 file2 ...
```
...
**Use template:** @/home/zury/workplace/01-lefarma-project/.opencode/get-shit-done/templates/summary.md
...
node "/home/zury/workplace/01-lefarma-project/.opencode/get-shit-done/bin/gsd-tools.cjs" roadmap update-plan-progress "${PHASE_NUMBER}"
...
```bash
node "/home/zury/workplace/01-lefarma-project/.opencode/get-shit-done/bin/gsd-tools.cjs" state add-blocker "Blocker description"
```
</state_updates>
