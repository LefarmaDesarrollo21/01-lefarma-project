...
Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/zury/workplace/01-lefarma-project/.opencode/get-shit-done
                  → writes to /home/zury/workplace/01-lefarma-project/.opencode/get-shit-done/hooks/
...
```bash
INIT=$(node "/home/zury/workplace/01-lefarma-project/.opencode/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/zury/workplace/01-lefarma-project/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/zury/workplace/01-lefarma-project/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
