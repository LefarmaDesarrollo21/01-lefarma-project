...
Intel system is disabled. To activate:
  ...
  node /home/zury/workplace/01-lefarma-project/.opencode/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /home/zury/workplace/01-lefarma-project/.opencode/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /home/zury/workplace/01-lefarma-project/.opencode/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /home/zury/workplace/01-lefarma-project/.opencode/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /home/zury/workplace/01-lefarma-project/.opencode/get-shit-done/bin/gsd-tools.cjs
