...
<required_reading>
@/home/zury/workplace/01-lefarma-project/.opencode/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/home/zury/workplace/01-lefarma-project/.opencode/get-shit-done/bin/gsd-tools.cjs" init resume)
