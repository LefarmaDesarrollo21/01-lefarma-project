...
- **Global scope**: `/home/zury/workplace/01-lefarma-project/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/zury/workplace/01-lefarma-project/.opencode/notes/`)
...
2. Glob `/home/zury/workplace/01-lefarma-project/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/zury/workplace/01-lefarma-project/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/zury/workplace/01-lefarma-project/.opencode/notes/` — works in any directory
